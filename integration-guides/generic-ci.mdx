---
title: "Generic CI"
description: "Push .notickets/ state from any CI system using the no-tickets CLI."
---
...
| `3` | Entitlement exceeded | warn but don't fail (volume is soft-capped) |

A `nt push --ci --on-entitlement-exceeded=fail` flag exists if you'd rather
treat soft-cap warnings as hard failures.
